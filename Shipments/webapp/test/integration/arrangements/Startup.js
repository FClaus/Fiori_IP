sap.ui.define([
	"sap/ui/test/Opa5",
	"be/ap/project/Shipments/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("be.ap.project.Shipments.test.integration.arrangements.Startup", {
